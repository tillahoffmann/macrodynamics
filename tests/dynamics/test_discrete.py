...
def test_discrete_diffusion_operator(discrete_diffusion_operator):
...
def test_discrete_averaging_operator(discrete_averaging_operator):
...
def test_discrete_diffusion_gradient(discrete_diffusion_operator):
